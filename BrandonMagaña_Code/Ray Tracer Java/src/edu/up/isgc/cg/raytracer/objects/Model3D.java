...
public class Model3D extends Object3D {
    ...
    public Model3D(Vector3D position, Triangle[] triangles, Color color, double shininess, double reflect, boolean transparency) {
        super(position, color,shininess,reflect,transparency);
